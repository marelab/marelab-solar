...
function _downloadMarelab(){
 	...
 	if [ "$MARELAB_OS" == "PC" ]; then
    	...
    	wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-plugin/X86-32/libmarelab-adapter-i2c"
    	wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-plugin/X86-32/libmarelab-plugin-led"
 		cd ..
 		cd marelab-cgi
 		wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-cgi/X86-32/marelab-cgi"
 		wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-cgi/X86-32/marelab-phcgi"
 	...
 	if [ "$MARELAB_OS" == "ARM" ]; then
    	...
    	cd marelab-plug
    	wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-plugin/ARM/libmarelab-adapter-i2c.so"
    	wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-plugin/ARM/libmarelab-plugin-led.so"
 		cd ..
 		cd marelab-cgi
 		wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-cgi/ARM/marelab-cgi"
 		wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-cgi/ARM/marelab-phcgi"
...
wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-scripts/init.lua"
...
wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-conf/boa.conf"
cd $MARELAB_BASE_DIR
cd marelab-aqua/marelab-web
wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-web/marelabwebpack.tar.gz"
...
cd $MARELAB_BASE_DIR
	cd marelab-aqua/temp-install
	wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-conf/marelab.conf"
...
cd $MARELAB_BASE_DIR
	...
	if [ "$MARELAB_OS" == "PC" ]; then
    	echo "downloading linux pc based version of marelab..."
    	wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-deamon/X86-32/marelab-nucleus"
 	fi	
 	if [ "$MARELAB_OS" == "ARM" ]; then
    	echo "downloading linux ARM based version of marelab..."
    	wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-deamon/ARM/marelab-nucleus"
 	fi
...
cd $MARELAB_BASE_DIR/marelab-aqua/temp-install    
    wget –quiet "$MARELAB_REPO/marelab-aqua-pi/marelab-conf/nucleus"
